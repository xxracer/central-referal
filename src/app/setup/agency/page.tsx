                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                required
                            // Allow checking/changing if param was missing, but ideally read-only if passed securely?
                            // For now, editable in case they need to correct it, but backend verifies payment.
                            />
